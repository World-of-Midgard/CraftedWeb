     ...
     ?>
        ...
        <div id="rightcontent">
             ...
             <div class="box_right_title">Recent forum activity</div>
                ...
                $result = $sql->query("SELECT poster_id,post_text,post_time,topic_id FROM phpbb_posts ORDER BY post_id DESC LIMIT 10");
                while($row = mysqli_fetch_assoc($result))
                {
                    $string = $row['post_text'];
                    $getUser = $sql->query("SELECT username FROM phpbb_users WHERE user_id='".$row['poster_id']."'");
                    $user = mysqli_fetch_assoc($getUser);
                    $getTopic = $sql->query("SELECT topic_title FROM phpbb_topics WHERE topic_id='".$row['topic_id']."'");
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo limit_characters(stripBBcode($string), null);?></td>
         ...
         <div class="box_right">
                ...
                <table>
                   <tr valign="top">
                       ...
                       <td>
                       <b>
                           <?php echo $server->getActiveConnections();?><br/>
                           <?php echo $server->getAccountsCreatedToday();?><br/>
                       </b>
                       </td>
                   </tr>
                </table>
        ...
        <table>
               <tr valign="top">
                   ...
                   <?php
                         ...
                         $get = $sql->query("SELECT version FROM db_version");
